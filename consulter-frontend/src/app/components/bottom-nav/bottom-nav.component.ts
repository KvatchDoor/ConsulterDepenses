  ...
  template: `
    <nav class="nav">
      <a routerLink="/" [routerLinkActiveOptions]="{ exact: true }" routerLinkActive="active" class="nav-item">
        ...
        <span class="nav-label">Solde</span>
      </a>
      <a routerLink="/nouveau" routerLinkActive="active" class="nav-item nav-item--new">
        <div class="nav-icon nav-icon--fab">
        ...
        <span class="nav-label">Saisir</span>
      </a>
    </nav>
  `,
